...
conversation_history = 'conversation_history_' + str(datetime.now()) + '.txt'
...
with model.chat_session(system_template, prompt_template):
    ...
    #    page = reader.pages[i] 
     ...
     #   message = 'Here is some new information about suspicious activity reports and the associated glossary codes: ' + text + '. No response is required, however you should retain this knowledge and use it in later questioning.'
    #    output = model.generate(message, max_tokens=4096, temp=0.7, top_k=40, top_p=0.4, repeat_penalty=1.18, repeat_last_n=64)
    #    print('> '  + output)
